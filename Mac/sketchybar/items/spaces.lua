...
local space_colors = {
	colors.slategray.light, -- Color for space 2
	colors.slategray.light,  -- Color for space 3
	colors.slategray.light, -- Color for space 4
	colors.slategray.light,   -- Color for space 5
	colors.slategray.light, -- Color for space 6
	colors.slategray.light, -- Color for space 7
	colors.slategray.light,  -- Color for space 8
	colors.slategray.light, -- Color for space 9
	colors.slategray.light, -- Color for space 10
}
