...
vim.keymap.set("n", "-", vim.cmd.Ex, { desc = "Open netrw Explorer" })
...
vim.keymap.set("n", "<leader>bp", ":bprev<CR>", { desc = "Previuos buffer" })
...
function FUNCS.client_remaps(bufnr, opts)
